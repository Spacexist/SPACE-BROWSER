...
* **🎯 浏览器激活模式（Browser Mode）**：
  ...
  - 按下 **ESC 键**一键退出聚焦，页面重新安全冻结；聚焦期间画布空白区域仍可正常拖动。
...
├── focus-manager.js   # 独立的 F / ESC 聚焦与交互状态机管理器
...
* **以鼠标为中心缩放**：滚动 **鼠标滚轮**。
* **聚焦卡片**：鼠标悬浮在任意卡片上，按下 **F** 键。Page 卡片聚焦时会额外解锁网页交互。
* **退出聚焦/重新锁定**：按下 **ESC** 键。聚焦期间仍可拖动画布空白区域。
